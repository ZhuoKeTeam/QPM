...
public class JMThreadManager {
    ...
    private static volatile JMThreadManager instance;
    ...
    public static JMThreadManager getInstance() {
        if (instance == null) {
            synchronized (JMThreadManager.class) {
                if (instance == null) {
                    instance = new JMThreadManager();
                }
            }
        }
        return instance;
