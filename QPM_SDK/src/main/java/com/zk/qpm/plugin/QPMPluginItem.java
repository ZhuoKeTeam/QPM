...
public class QPMPluginItem {
    ...
    private QPMPluginTaskExecutor mExecutor;

    public QPMPluginItem(String name,
                         String alias,
                         String descriotion,
                         int logo_id,
    ...
    public void setTaskExecutor(final QPMPluginTaskExecutor executor) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof QPMPluginItem)) {
            return false;
        }
        QPMPluginItem otherItem = (QPMPluginItem) other;
