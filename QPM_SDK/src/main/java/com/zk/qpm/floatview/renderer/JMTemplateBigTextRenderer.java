...
public class JMTemplateBigTextRenderer extends BaseTemplateRenderer {

    public static final String PARAM_BIG_TEXT = "param_big_text";

    public JMTemplateBigTextRenderer(Map<String, Object> mParam) {
        super(mParam);
    }

    @Override
    public String type() {
        return JMFloatViewType.TYPE_FLOAT_VIEW_TEMPLATE_BIG_TEXT;
    }
