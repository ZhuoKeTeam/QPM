...
public class JMFloatViewBean {

    public @JMFloatViewType.Type String type;
    // 开关显示的名字
    ...
    public JMFloatViewBean(String type, String switchName, String switchTip, boolean switchDefault, int switchSort) {
        this.type = type;
